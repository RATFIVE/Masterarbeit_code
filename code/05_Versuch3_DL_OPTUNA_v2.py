...
from utils.Model_ConvLSTM import CNNLSTM_Regression_Classification, CNNLSTM_Regression_V2
...
storage = f"sqlite:///Versuch3_ConvLSTM_Regression_V2_cv_light_mode={light_mode}.db"
...
def cross_validation_loop(model_name, folds, X, y_lagged, y, common_time, time_delta, trial_params, trial:optuna.Trial=None, batch_size=32):
    ...
    for surge_name, fold in folds.items():
        ...
        if trial.should_prune():
            ...
            plt.savefig(f"RegressionV2_predicted_vs_true_{surge_name}_score_{score}_classification_{classification}_HORIZON_{HORIZON}.png")
