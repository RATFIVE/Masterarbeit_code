...
class EvaluationMLModel:
    def __init__(self, model_type, df, h=24, ocean_points=30, Versuch: str = "1", trial_name: str = "default", n_jobs=n_jobs):
...
model_stats_all.to_csv("../thesis_plots/Versuch2_ML_model_statistics_all_models.csv", index=False)
